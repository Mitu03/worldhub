    ...
    <div class="global-trade-section Business---">
      <div className="Impact-Business-1">
        ...
        <p>
          ...
          resources. However, it also exposes them to increased competition and
          regulatory challenges.
        </p>
        <p>
          Companies can now source raw materials from multiple countries,
          reducing costs while accessing global markets to sell their products.
        ...
        <ul>
          ...
          <li>
            <strong>Supply Chain Globalization:</strong> Global supply chains
            reduce production costs but introduce risks like geopolitical
            disruptions.
          </li>
          <li>
            <strong>Regulatory Challenges:</strong> Companies must comply with
            different trade laws and tariffs in every country they operate.
          </li>
        </ul>
      </div>
...
export default ImpactBusinesses;
